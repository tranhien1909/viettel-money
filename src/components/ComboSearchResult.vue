<template>
  <section class="mt-8">
    <!-- Combo Cards -->
    <div class="flash-sale-container mt-4">
      <div class="flash-sale-card mt-4 mb-4">
        <div class="card">
          <img src="/img/combo1.png" class="card-img-top" alt="Tour Image" />
          <div class="card-body">
            <h5 class="card-title">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div>Còn lại: 10</div>
              <span class="text-decoration-line-through text-muted price-origin"
                >13,863,000₫</span
              >
            </div>
...
const timer = ref({ hours: "15", minutes: "30", seconds: "05" });
let countdownInterval;

const startCountdown = () => {
  // In a real application, you'd calculate the remaining time from a target end date.
  // For this example, we'll just decrement from initial values.
  let totalSeconds =
    parseInt(timer.value.hours) * 3600 +
    parseInt(timer.value.minutes) * 60 +
    parseInt(timer.value.seconds);

  countdownInterval = setInterval(() => {
    if (totalSeconds <= 0) {
      clearInterval(countdownInterval);
      timer.value = { hours: "00", minutes: "00", seconds: "00" };
      return;
    }
